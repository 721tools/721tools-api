...
import { KmsSigner } from '../kms/kms-signer';

export const preCreateCollectionOffer = async (address, smartAddress, contractAddress, slug, price, days) => {
    ...
    const kmsSigner = new KmsSigner(address, provider);
